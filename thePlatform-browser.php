...
<div class="wrap">
	<?php if ( ! $IS_EMBED ) {
		echo '<div class="MediaAMP_icon" style="margin-left: 10px; margin-top: 15px">
		<img src="/itconnect/wp-content/plugins/MediaAMP-video-manager/images/MediaAMP-light.png" height="20px">
		</div>';
	} ?>
